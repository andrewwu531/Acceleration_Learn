 ...
 return (
     ...
     <div className="flex flex-col items-center justify-center max-w-3xl mx-auto xl:max-w-4xl bg-gray-150" style={{ marginBottom: "17vh"}}>
        ...
        <div className="flex justify-center text-2xl font-semibold text-center underline xl:text-3xl"  style={{ marginTop: "12vh", marginBottom: "5vh"}}>
            Mission Statement
        </div>
        ...
        <div className="text-xl font-normal">  
            ...
            I treat these courses as the life-long goal that must be excelled 
