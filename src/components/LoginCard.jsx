  ...
  return (
    <div>
      <nav className="flex items-center justify-between py-5 bg-black">
        ...
        <div className="hidden lg:block lg:w-auto">
          <ol className="lg:flex lg:space-x-8 lg:font-medium lg:text-white lg:pr-20">
            ...
            <li>
              <a href="/weightlifting-course" className=" hover:text-gray-300">
                Nutrition & Weightlifting
              </a>
            </li>
            <li>
              <a href="/english-course" className="hover:text-gray-300">
                Social & Business English Language
              </a>
            </li>
            <li>
      ...
      <div className="relative">
        <div
          className="absolute inset-0 bg-[position:center_top] h-[87.5vh]"
        ...
        <Card className="flex justify-center max-w-sm mx-auto top-24">
          <Typography
            variant="h3"
            className="flex justify-center mx-auto text-gray-900 pt-7"
          >
            Sign In
          </Typography>
